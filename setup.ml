...
(* OASIS_START *)
(* DO NOT EDIT (digest: 25454b9808f517ec3f79bf2d653c90be) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some [OASISText.Para "SKK server using sqlite3 dictionaries"];
          categories = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\182\246I\166\149\239\245;\168\186\192\205\169\017B\216";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
