...
(* OASIS_START *)
(* DO NOT EDIT (digest: c96e07881595816dc7d2fd489e68c98b) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/anyakichi/ocaml-skkserv-lite";
          synopsis = "SKK server using sqlite3 dictionaries";
          description =
            Some
              [
                 OASISText.Para
                   "skkserv-lite is a SKK server that uses a sqlite3 database as a dictionary.  It can use multiple dictionaries and respond to a completion request."
              ];
          categories = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/anyakichi/ocaml-skkserv-lite.git";
                      src_repo_browser =
                        Some
                          "https://github.com/anyakichi/ocaml-skkserv-lite";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "e\230\028\000@%bV7\244f\131Q\242e\160";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
